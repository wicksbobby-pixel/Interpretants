import { NOUNS, ADJECTIVES, VERBS, VOCABULARY } from './domain/vocab';
import { CASE_ABBREV, type FormCell } from './domain/types';

/**
 * Stage 1 has no game UI yet — this is a debug dump so the data model and
 * seed vocabulary can be inspected directly. The drilling loop replaces
 * this in stage 2.
 */
...
function renderApp() {
  ...
  app.innerHTML = `
    ...
    <div class="dbg-root">
      ...
      <div class="subtitle dbg-mono">stage 1: schema + seed vocabulary, no drilling UI yet</div>
      <div class="counts">
